...
namespace SampleMulticlassClassification.ConsoleApp
{
    class Program
    {
        ...
        private const string MODEL_FILEPATH = @"model.zip";

        //Dataset to use for predictions 
        private const string DATA_FILEPATH = @"C:\developing\ML\ml.net\github\mlnet-cli\multiclass-classification\iris.csv";
